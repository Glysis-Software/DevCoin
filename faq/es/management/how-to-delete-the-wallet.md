...
To delete wallet(s) and related data from :
...
The unlink action merely deletes the private key controlling the wallet from the app. To restore a deleted wallet in the future the users require the private key (or mnemonic phrase) associated with it. Restoring access to a deleted wallet without knowing its private key (or mnemonic phrase) is impossible.
