...
Apart from monitoring the transaction status within , users may use one of the publicly available Ethereum block explorers (i.e. [https://etherscan.io](https://etherscan.io)) for monitoring as well. For that, users may simply search for the transaction ID on a public block explorer for the Ethereum blockchain.
